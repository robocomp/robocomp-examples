 ...
 *
 * The keyboardRobotController component...
 *
...
class keyboardRobotController : public RoboComp::Application
{
public:
	keyboardRobotController (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::keyboardRobotController::initialize()
{
...
int ::keyboardRobotController::run(int argc, char* argv[])
{
...
int main(int argc, char* argv[])
{
	...
	::keyboardRobotController app(prefix);
