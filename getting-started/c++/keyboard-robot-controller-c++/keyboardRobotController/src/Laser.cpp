...
RoboCompLaser::Laser::_iceD_getLaserAndBStateData(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    ::RoboCompLaser::TLaserData ret = this->getLaserAndBStateData(iceP_bState, current);
    auto ostr = inS.startWriteParams();
...
RoboCompLaser::LaserPrx::_iceI_getLaserAndBStateData(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::RoboCompLaser::Laser::GetLaserAndBStateDataResult>>& outAsync, const ::Ice::Context& context)
{
    ...
    outAsync->invoke(iceC_RoboCompLaser_Laser_getLaserAndBStateData_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        ...
        {
            ::RoboCompLaser::Laser::GetLaserAndBStateDataResult v;
...
void
::IceProxy::RoboCompLaser::_readProxy(::Ice::InputStream* istr, ::IceInternal::ProxyHandle< ::IceProxy::RoboCompLaser::Laser>& v)
{
    ::Ice::ObjectPrx proxy;
    istr->read(proxy);
    if(!proxy)
...
RoboCompLaser::Laser::_iceWriteImpl(::Ice::OutputStream* ostr) const
{
    ...
    Ice::StreamWriter< ::RoboCompLaser::Laser, ::Ice::OutputStream>::write(ostr, *this);
    ostr->endSlice();
}
...
{
    istr->startSlice();
    Ice::StreamReader< ::RoboCompLaser::Laser, ::Ice::InputStream>::read(istr, *this);
    istr->endSlice();
}
