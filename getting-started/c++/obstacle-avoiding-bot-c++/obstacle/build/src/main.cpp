 ...
 *
 * Just: "${PATH_TO_BINARY}/obstacle --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class obstacle : public RoboComp::Application
{
public:
	obstacle (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::obstacle::run(int argc, char* argv[])
{
