 ...
 *
 * Just: "${PATH_TO_BINARY}/square --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class square : public RoboComp::Application
{
public:
	square (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::square::run(int argc, char* argv[])
{
