 ...
 *
 * Just: "${PATH_TO_BINARY}/dist --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class dist : public RoboComp::Application
{
public:
	dist (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::dist::run(int argc, char* argv[])
{
